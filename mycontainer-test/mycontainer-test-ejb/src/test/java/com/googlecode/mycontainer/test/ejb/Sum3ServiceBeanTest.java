...
import com.googlecode.mycontainer.test.ejb.Sum3ServiceBean;

public class Sum3ServiceBeanTest {

	private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory
			.getLogger(Sum3ServiceBeanTest.class);
	...
	public void setUp() throws Exception {
		...
		deployer.deploy(Sum3ServiceBean.class);
	}

	@Test
	public void testLookup() throws Exception {
		InitialContext ic = new InitialContext();
		Object obj = ic.lookup("Sum3ServiceBean/local");
		assertTrue(obj instanceof Sum4Service);
	}
