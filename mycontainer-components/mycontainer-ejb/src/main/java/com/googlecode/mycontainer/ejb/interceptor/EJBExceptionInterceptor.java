...
public class EJBExceptionInterceptor extends ContextInterceptor {

	private static final long serialVersionUID = -8847984975527874386L;

	private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(EJBExceptionInterceptor.class);
	...
	public Object intercept(Request request, ProxyChain chain) throws Throwable {
		try {
			...
			LOG.error("RuntimeException on EJB call", e);
